...
function Signup() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    const isFirebaseConfigured = !import.meta.env.VITE_FIREBASE_API_KEY?.includes('your-api-key');
    
    if (!isFirebaseConfigured) {
      showToast('Google Sign-In requires Firebase configuration. Please set up Firebase first.', 'warning');
      return;
    }
